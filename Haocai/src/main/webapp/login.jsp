...
<head>
  ...
  <link rel="stylesheet" media="screen" href="loginjs/css/style.css">
  <link rel="stylesheet" type="text/css" href="loginjs/css/reset.css"/>
   <script src="loginjs/jquery-1.10.1.min.js"></script>
